...
import { Menu, X } from "lucide-react"; // Importing clean icons
...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      {isMobileMenuOpen && (
        <div className="absolute top-full left-0 w-full mt-4 p-6 bg-[#0c0c0e]/95 backdrop-blur-xl border border-zinc-800 rounded-3xl flex flex-col gap-6 shadow-2xl md:hidden">
          {navLinks.map((link) => {
            const isActive = activeSection === link.href.replace("#", "");
            return (
              <a
