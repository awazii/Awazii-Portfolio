      ...
      <Container className="flex flex-col gap-8 py-0 md:py-0">
        ...
        <div className="flex flex-col gap-6 max-w-4xl">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            {/* Transparent-Friendly Logo Box */}
            <div className="w-16 h-16 md:w-20 md:h-20 border-zinc-400 border  rounded-2xl flex items-center justify-center p-3 shadow-md shadow-zinc-100/50 shrink-0">
              {project.logoUrl ? (
                <img 
                  src={project.logoUrl} 
                ...
                // Fallback default stylized text indicator if logoUrl is missing
          ...
          <div className="flex flex-wrap items-center gap-3 text-[10px] font-bold uppercase tracking-widest text-zinc-200">
            <span className="px-3 py-1.5 bg-zinc-800 border border-zinc-700 rounded-full shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-6 mt-6 pt-2 border-t border-zinc-100">
          ...
          {/* Secondary View Gallery Link Button */}
          <button 
            onClick={() => document.getElementById('interface-gallery')?.scrollIntoView({ behavior: 'smooth' })}
