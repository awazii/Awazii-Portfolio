    ...
    <section className="w-full bg-[#fafafa] ">
      <Container className="py-0 md:py-0">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          {/* Left Column: Overview & Logic Architecture */}
          <div className="lg:col-span-8 flex flex-col gap-12">
            ...
            {/* The Logic Architecture (Dark Theme) */}
            <div className="bg-zinc-800 border border-zinc-700 rounded-3xl p-8 lg:p-10 shadow-xl shadow-zinc-900/10 relative overflow-hidden group">
          ...
          {/* Right Column: The Honest Metadata Box */}
