    ...
    <section id="about" className="w-full border-t border-zinc-800">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
          ...
          {/* Box 1: Profile */}
          <div className="bg-zinc-800 border border-zinc-700 p-6 lg:p-8 rounded-3xl flex flex-col gap-4 hover:border-zinc-600 transition-colors">
            <span className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Profile</span>
            <div>
          ...
          <div className="md:col-span-2 bg-zinc-800 border border-zinc-700 p-6 lg:p-8 rounded-3xl flex flex-col gap-4 hover:border-zinc-600 transition-colors">
            <span className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Technical Focus</span>
            <p className="text-zinc-200 leading-relaxed text-sm lg:text-base font-medium">
            ...
            <div className="flex flex-wrap gap-2 mt-auto pt-6">
              {skillsData[0].items.map((tech) => (
                <Tag key={tech} variant="dark" className="border-zinc-700 border text-zinc-100">
                  {tech}
                </Tag>
              ))}
            </div>
          ...
          {/* Box 3: Education & Milestones */}
         {/* Box 3: Education & Experience */}
          <div className="bg-zinc-800 border border-zinc-700 p-6 lg:p-8 rounded-3xl flex flex-col gap-4 hover:border-zinc-600 transition-colors">
            <span className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Education & Experience</span>
          ...
          <div className="md:col-span-2 bg-zinc-800 border border-zinc-700 p-6 lg:p-8 rounded-3xl flex flex-col gap-4 hover:border-zinc-600 transition-colors">
            <span className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Beyond The Code</span>
